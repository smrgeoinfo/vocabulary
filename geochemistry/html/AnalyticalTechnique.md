...
- **Source:**
SMR add general categories to group Geo-X categories
...
- **Source:**
SMR add general method categories
...
Namespace: 
[`http://w3id.org/ogeochem/def/1/analyticaltechnique/workflow`](http://w3id.org/ogeochem/def/1/analyticaltechnique/workflow)
...
- [Workflow component](#workflowcomponent)
    - [Autoanalyzer](#lab04)
    - [Laboratory autosampler](#lab33)
    - [Flow injection analyzer](#lab36)
...
- **Source:**
SMR add general workflow component categories
...
oxygenated or inert atmosphere.  Component step in elemental analysis
