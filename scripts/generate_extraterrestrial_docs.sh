...
SOURCE_BASE="https://raw.githubusercontent.com/smrgeoinfo/vocabulary/main/ETmaterials/"
SOURCES=(  "ExtraterrestrialMaterialsMindat.ttl" )
DEST_FOLDER="../etmaterial/html/"
mkdir -p "${DEST_FOLDER}"
